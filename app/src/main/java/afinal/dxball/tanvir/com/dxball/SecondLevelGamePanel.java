...
/**
 * Created by Tanvir on 07-May-17.
 */

public class SecondLevelGamePanel extends View {
    private Ball ball;
    private Brick box;
    ...
    public static SecondLevelGamePanel.AccelerometerSensorManagement2 accelerometerSensorManagement;
    ...
    public SecondLevelGamePanel(final Context context){
        super(context);
        ...
        bar = new Bar(Color.BLUE);         // blue bar
        bar.set(230,600,200,50);
        ...
        accelerometerSensorManagement = new SecondLevelGamePanel.AccelerometerSensorManagement2(context);
            ...
            public void run() {
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        if(bar.getLeft() >0 && bar.getLeft() <screenMaxX-200){
                            bar.set(bar.getLeft() + -1*(int)accelerometerSensorManagement.getX(), screenMaxY-51, 200, 50);
                        }
                        ...
                        else if(bar.getLeft() >=screenMaxX-200 && accelerometerSensorManagement.getX() > 0){   // right exception
    ...
    //=====================================================SENSOR Input Class=================================================
    class AccelerometerSensorManagement2 implements SensorEventListener {
        ...
        public AccelerometerSensorManagement2(Context context){
